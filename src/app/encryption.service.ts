...
export class EncryptionService {
    ...
    decompressFromBase64(b) {
        return null == b ? "" : "" == b ? null : this._decompress(b.length, 32, function (c) {
            return this.a("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d", b.charAt(c));
        })
    }
